		...
		<br>
			...
			<table>
				...
				<tr>
					...
					<input type="button"	id="startTime"		name="startTime" 	value="날짜" class="c-btn start-datepicker-btn"/><br>
					</td>
				</tr>
				<tr>
					...
					<input type="button"id="endTime"	name="endTime"		value="날짜" class="c-btn end-datepicker-btn"/>
					</td>
				</tr>
				<tr>
...
%>							
				...
				<tr>
					...
					<input type="button" id="calendarInsert"name="calendarInsert"value="일정등록"/>
					<input type="button" id="calendarDelete"name="calendarDelete"value="일정삭제"/>
					<input type="button" id="calendarReset" name="calendarReset" value="초기화"/>
					<input type="button" id="popupClose"	name="popupClose" 	 value="닫기"/>
					</td>
				</tr>		
			</table>
		</form>
