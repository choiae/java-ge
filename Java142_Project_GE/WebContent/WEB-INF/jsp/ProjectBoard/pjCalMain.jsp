...
%>
	<head>
		...
		$(document).ready(function(){
			...
			var screenW = screen.availWidth;  // 스크린 가로사이즈 1280
			 console.log("screenW >>" + screenW);
	         var screenH = screen.availHeight; // 스크린 세로사이즈 720
	         console.log("screenH >>" + screenH);
	         var popW = 300;
	         var popH = 200;
	         var posL =1000;   // 띄울창의 가로 포지션
	         var posT =1000;   // 띄울창의 세로 포지션
...
//      				aspectRatio: 2,
			    	dayClick  :  function(date){
			    		window.open("","calendarPopup",'width='+ popW +',height='+ popH +',top='+ posT +',left='+ posL +',resizable=no,scrollbars=no');
			    		$("#calDetail").attr("target","calendarPopup");
	                    $("#calDetail").attr("action","/pjCalendar/calPopup.ge");
			    		$("#calDetail").attr("target","calendarPopup");
                    ...
                    eventClick : function(event){
                    	if (events) {
                    		...
                    		console.log("pcno >>> " + pcno);
                   	      	window.open("","calDetail",'width='+ popW +',height='+ popH +',top='+ posT +',left='+ posL +',resizable=no,scrollbars=no'); 
