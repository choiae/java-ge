			...
			<div class="outertable">
				<div class="ge_sidemenu">
						...
						<table width="950px" style="margin:20px 0px 0px 10px; border-collapse: collapse; border:0px;">
								...
								<td>
									<div id="UpDelbutton" style="margin:0px 0px 0px 0px;">
										<table>
											<tr>
												<td align="right">
												<input type="button" value="글수정하기" id="BNUForm" name="BNUForm"> | 
												<input type="button" value="글삭제하기" id="BNDelete" name="BNDelete">
												</td>
											</tr>	
										</table>
									</div>
							...
							<tr>
								...
								<table id="BNWrite" width="900px" height="430px" style="border-collapse: collapse; border:0px; ">
									...
									<tbody>
										<tr height="40px" style="background:#999999; text-align: center;">
											<th style="font-size: 12px;">제목</th>
											<th style="font-size: 12px;" colspan="5"><%=bnvo.getBnsubject() %></th>
										</tr>
										<tr height="40px" style="background:#999999; text-align:center; font-size:12px;">
											<th>작성자</th>
					<%
										String jobcd = "";
										jobcd = bnvo.getJobcd();
					...
					%>
										...
										<tr>
											<th style="background:#999999; text-align: center; height:100px;" rowspan="2">내용</th>
										...
										<tr height="10px">
											<td align="left">
												<input type="button" value="글쓰기" id="BNInsert" name="BNInsert">
											</td>
											<td align="right" colspan="5">
												<input type="button" value="목록" id="BNList" name="BNList">
											</td>
										</tr>
									</tbody>
								</table>						
