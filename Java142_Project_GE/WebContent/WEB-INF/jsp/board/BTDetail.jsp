								...
								<td>
									<div id="UpDelbutton" style="margin:0px 0px 0px 0px;">
										<table>
											<tr>
												<td align="right">
												<input type="button" value="글수정하기" id="BTUForm" name="BTUForm"> | 
...
%>
										...
										<tr height="10px">
											<td align="left" colspan="3">
												<input type="button" value="글쓰기" id="BTInsert" name="BTInsert">
											</td>
											<td align="right" colspan="3">
												<input type="button" value="목록으로 돌아가기" id="BTList" name="BTList">
											</td>
										</tr>
										<tr>
										<!-- 댓글 -->
