...
%>																				
										...
										<tr height="50x">
											<th style="background:#9E9E9E; text-align: center; font-size: 18px;">제목
											...
											<th style="background:#9E9E9E; text-align: center; font-size: 18px;">공지여부선택</th>
											<td>
					...
					%>		    
										...
										<tr height="300px">
											<th style="background:#9E9E9E; text-align: center; font-size: 18px;">내용</th>
										...
										<tr height="50px">
											...
											<td colspan="3" align="right">
												<div id="BDButton">
													<input type="button" value="수정" name="BDUpdate" id="BDUpdate">
													<input type="button" value="목록" name="BDList" id="BDList">			
												</div>												
											</td>
										</tr>
									</table>		
