								...
								<br>
									<table id="BDWrite" width="900px" height="430px" style="border-collapse: collapse; border:0px;">
										...
										<tr>
											...
											<th style="background:#9E9E9E; text-align: center;">업무여부선택</th>
											<td>
											...
											<th style="background:#9E9E9E; text-align: center;">공지여부선택</th>
											<td>
										...
										<tr height="50px">
											<td colspan="5" align="right">
												<div id="BDButton">
													<input type="button" value="저장" name="BDInsert" id="BDInsert">
