		...
		<table width="950px" style="margin:20px 0px 0px 10px; border-collapse: collapse; border:0px;">
			...
			<tr>
				<td colspan="5" align="right" >
					<input type="button" value="글 쓰기" id="BNInsert" name="BNInsert">
					<br>
					<br>
				</td>
			</tr>
...
%>
				<td><span class="goDetail">[공지] <%=bnvo.getBnsubject().substring(0,12)+"......" %><br></span></td>

<%					
				}else{
%>
				<td><span class="goDetail">[공지] <%=bnvo.getBnsubject() %></span><br></td>
<%					
				}
				String jobcd = "";
				jobcd = bnvo.getJobcd();
