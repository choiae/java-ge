						...
						<table width="950px" style="margin:20px 0px 0px 10px; border-collapse: collapse; border:0px;">
							...
							<tr>
								<td colspan="5" align="right" >
									<input type="button" value="글 쓰기" id="BDInsert" name="BDInsert">
									<br>
									<br>
								</td>
							</tr>
							<tr style="background:#999999; text-align: center;  border-bottom: 1px solid #444444;">
								<th>글번호
							...
							<table style="padding:0px 0px 0px 16px">
								<tr>
									...
									<select id="search" name="search" style="height:26px; width:51px;">
										<option value="bdsubject">제목</option>
