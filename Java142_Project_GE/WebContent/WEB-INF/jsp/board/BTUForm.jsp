...
%>																				
										...
										<tr height="50px">
											<td align="left">
												<div id="BTButton">
													<input type="button" value="글삭제하기" id="BTDelete" name="BTDelete">
												</div>
											</td>
											<td colspan="3" align="right">
												<div id="BTButton">
													<input type="button" value="수정" name="BTUpdate" id="BTUpdate">
													<input type="button" value="목록" name="BTList" id="BTList">			
												</div>												
											</td>
										</tr>
									</table>		
